...
class RNN(nn.Module):
    """
    Reimplementation (copy) of original model defined in pytorch turorial
...
# -------------------------------------------
# Implementing the BaseFairseqModel interface
# -------------------------------------------

@register_model('rnn_classifier')
class FairseqRNNClassifier(BaseFairseqModel):
    """
    wrapper class: All registered models MUST implement the BaseFairseqModel interface
    """
    ...
    def build_model(cls, args, task):
        ...
        # In this case we'll just return a
        # FairseqRNNClassifier instance.
...
# ------------------------------------------------------------------
# Defining a named architecture with the configuration for our model
# ------------------------------------------------------------------
