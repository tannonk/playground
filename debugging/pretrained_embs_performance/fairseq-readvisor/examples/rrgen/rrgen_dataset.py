...
Modification of language_pair_dataset.py for RRGen
...
class RRGenDataset(FairseqDataset):
    """
    Modification of LanguagePairDataset for RRGen

    A set of torch.utils.data.Datasets.
    ...
    def __getitem__(self, index):
        ...
        # ext_cate_item = torch.LongTensor(
